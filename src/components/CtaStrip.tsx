...
export const CtaStrip = ({
  ...
  <section
    className="relative text-white px-5 md:px-14 py-6 grid items-center gap-7"
    style={{
      gridTemplateColumns: 'minmax(0,260px) 1px 1fr auto',
      background:
  ...
  >
    ...
    <div className="w-px h-[60px] bg-white/20 hidden md:block" />
